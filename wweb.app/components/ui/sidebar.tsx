  ...
  (
    ...
    return (
      ...
      >
        ...
        <div
          className={cn(
            "relative h-screen w-[--sidebar-width] bg-transparent transition-all ease-linear",
        ...
        <div
          className={cn(
            "fixed inset-y-0 z-10 hidden h-screen w-[--sidebar-width] transition-[left,right,width] ease-linear md:flex",
            side === "left"
